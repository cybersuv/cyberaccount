...
<body>
<center>
<form:form id="expenseForm" action="#" method="POST">
<table class="formtable" cellspacing="0" >
<tr>
<td colspan="2" bgcolor="#848484" align="center"><font color="white">Expense Entry</font></td>
</tr>
<tr>
<td>Account</td>
...
<script>
  ...
  $( "#expenseForm" ).submit(function( event ) {
	...
	url = '${pageContext.request.contextPath}/submitexpense';
	...
	posting.done(function( data ) {
		if(data.split('|')[0]=='true'){
			...
			$( "#result" ).empty().append('Successfully created expense entry with transaction ID : '+ data.split('|')[1]);
