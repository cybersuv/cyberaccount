...
<div class="title-pane title-text"><span id="app_title" title="Application Title">${appname} [${authuser.org_mnemonic}]</span></div>
...
<ul style="width:150px;" id="menu">
	...
	<li>Transactions
		<ul>
			<li onClick="javascript:navigateDeposite();">Deposit</li>
			<li onClick="javascript:navigateExpense();">Expense</li>
		</ul>
	</li>
	<li>Settings</li>
...
<div id="container" class="container">Hi</div>
</div>
...
function navigateDeposite(){
	$.get( "${contextPath}/depositentry", function( data ) {
		$('#container').html(data);
		});
}

function navigateExpense(){
	$.get( "${contextPath}/expenseentry", function( data ) {
		$('#container').html(data);
		});
}
